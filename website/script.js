...
function initTypewriter() {
    ...
    async function startTyping() {
        for (let i = 0; i < phrases.length; i++) {
            ...
            await typeWriter(typewriterElement, phrases[i], 120);
            await new Promise(resolve => setTimeout(resolve, 300)); // Pause between phrases
        }
        
        // Add final shimmer effect
        setTimeout(() => {
            typewriterElement.style.animation = 'shimmer 2s ease-in-out';
        }, 500);
    }
